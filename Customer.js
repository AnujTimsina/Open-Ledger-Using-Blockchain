...
class EvaluateIpfs extends Component {
    ...
    render(){
        ...
        for (let index = 0; index < this.props.addressObj.length; index++) {
            ...
            async function getdata_ipfs(data_id){
                //console.log("BICH MA XHU");
                //console.log(data_id);
                //console.log("YO HO DATA");
                //console.log("SEE IF STAA_ID")
                //console.log(data_id)
                console.log("YAHA BHITRA");
                const node = await IPFS.create({repo: 'ok' + Math.random()})
        
                //const dat = node.cat(data_id)
                const stream = node.cat(data_id)
                let dat = ''
                ...
                //console.log("YAHA BHITRA");
                console.log("SOMEONE" + dat);
                return(dat);
            }
            const data = getdata_ipfs(ipfsAddress);
            ...
            <div>
                <div className="verifier-entire">
                    <div className="dash-nav">
                        <div>
                            <h1 className="dash-title">Open Ledger</h1>
                        </div>
                    ...
                    <div className="verifier-header">
                        <div className="main-header">
                            <div className="verifier">
                                ...
                                <div className="verifier-title"><h1 style={{ fontSize: '3rem' }}>Customer</h1></div>
                            </div>
